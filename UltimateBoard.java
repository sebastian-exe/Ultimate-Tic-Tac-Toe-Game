...
//creates a 2D array of type TicTacToeBoards, runs and displayer
//the ultimate board
...
public class UltimateBoard implements IBoard {
	...
	//check is player X has won on of the individual Tic-Tac-Toe board games
	...
	//check is player Y has won on of the individual Tic-Tac-Toe board games
