...
//This is the same thing as the Tic tac toe.java from the github repository
...
public class DriverMain {
	 public static void main(String[] args) {
		...
		//lets name random to the same as the AI
			...
			playerO = new AIComputerPlayer();
		}
		//smart AI is the same as the cut throat
		else if(Y.equalsIgnoreCase("smartai")) {
			playerO = new SmartComputerPlayer();
		}
		else {
			System.out.println("Please enter either human, AI, or smartAI");
			System.exit(0);
		...
		UltimateTicTacToeGame board = new UltimateTicTacToeGame();
