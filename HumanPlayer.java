...
//is ran whenever the parameter human is read in from the keyboard
import java.util.*;
public class HumanPlayer extends Player {
	...
	/*
     ...
     Post: The miniBoard played has been assigned to the board
     */
	public int makeMove(TicTacToeBoard inBoard) {
		...
		try {
			...
			// checking for valid miniBoard between 1 and 9
			if (inputVal < 1 || inputVal > 9 || !inBoard.isValidminiBoard(inputVal)) {
