...
public class TicTacToeBoard implements IBoard {
	...
	public void printValidSpots() {
		...
		if (space[0][0] == 0) System.out.print("1, ");
		if (space[0][1] == 0) System.out.print("2, ");
		if (space[0][2] == 0) System.out.print("3, ");
		if (space[1][0] == 0) System.out.print("4, ");
		if (space[1][1] == 0) System.out.print("5, ");
		if (space[1][2] == 0) System.out.print("6, ");
		if (space[2][0] == 0) System.out.print("7, ");
		if (space[2][1] == 0) System.out.print("8, ");
		if (space[2][2] == 0) System.out.print("9"); 
